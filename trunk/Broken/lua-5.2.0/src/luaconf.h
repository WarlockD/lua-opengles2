...
*/
#define lua_str2number(s,p)	(LUAI_UACNUMBER)strtod((s), (p))
...
#include <math.h>
#define luai_nummod(L,a,b)	((a) - (LUAI_UACNUMBER)floor((a)/(b))*(b))
#define luai_numpow(L,a,b)	((LUAI_UACNUMBER)pow(a,b))
#endif
